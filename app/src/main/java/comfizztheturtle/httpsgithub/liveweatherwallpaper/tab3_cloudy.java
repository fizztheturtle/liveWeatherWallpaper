...
public class tab3_cloudy extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.tab3_cloudy, container, false);
        image=v;
        ImageView new_image_device =image.findViewById(R.id.image_device_cloudy);
        if (mSelectedImageUri != null) {
            new_image_device.setImageURI(mSelectedImageUri);
        }

        Button get_image_button = v.findViewById(R.id.get_image_button_cloudy);
